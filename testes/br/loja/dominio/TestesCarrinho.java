...
public class TestesCarrinho {
	...
	public void deveriaTotalizarCarrinhoComProdutos() {
		...
		// Ação & Verificação
		assertEquals("O valor total do carrinho não é o esperado.",
	...
	public void deveriaTotalizarCarrinhoSemProdutos() {
		...
		assertEquals(
				"O valor total do carrinho sem produtos não é o esperado.",
	...
	public void deveriaTotalizarApenasSubTotal() {
		...
		assertEquals("O valor do sub total não está correto.",
	...
	public void deveriaTotalizarApenasValorTotalDoFrete() {
		Carrinho carrinho = CriadorDeCarrinho
				...
				.comProduto(
						CriadorDeProduto.umProduto().comSKU("PRD-0009")
								.comPreco(22.0).criar()).criar();
		assertEquals("O valor total do frete não está correto.",
	...
	public void deveriaRetornarValorZeroSemProdutos() {
		...
		assertEquals("O valor do frete sem produtos não está correto.",
	...
	public void deveriaExistirApenasUmItemNoCarrinho() {
		...
		assertEquals("A quantidade itens do carrinho não está correta.",
	...
	public void deveriaNaoPermitirAdicionarItemDiretamenteAoCarrinho() {
		...
		try {
			...
			fail("Não deveria permitir adicionar um item diretamente ao carrinho.");
		} catch (RuntimeException e) {
			assertEquals("A mensagem de erro não confiz com o esperado.",
